...
<div class="container">
  ...
  <!-- Sidebar -->
    ...
    <ul class="menu">
      ...
      <li><a href="../admin/pages/QuanLyuser.php">Quản lý người dùng</a></li>
      <li><a href="../admin/pages/DanhMuc.php">Danh mục</a></li>
      <li><a href="../admin/pages/QuanLySanPham.php">Sản phẩm</a></li>
      <li><a href="../admin/pages/NhaphangGiaban.php">Quản lý nhập hàng</a></li> 
      <li><a href="../admin/pages/NhaphangGiaban2.php">Quản lý giá bán</a></li> 
      <li><a href="../admin/pages/QuanLyDonHang.php" > Quản lý đơn đặt hàng </a></li> 
      <li><a href="../admin/pages/QuanLyTonKho.html">Quản lý tồn kho</a></li> </ul>
