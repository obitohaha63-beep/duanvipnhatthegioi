...
<head>
  ...
  <link rel="stylesheet" href="../assets/css/admindangnhap.css">
  <link rel="stylesheet" href="../assets/css/fontinter.css">
  <link rel="stylesheet" href="../assets/css/root.css">
</head>
<body>
  <img src="../assets/img/nenadmin.jpg" class="background-img">
  <div class="bg"></div>

  <main class="container">
    <section class="card" aria-labelledby="login-title">
      <h1 id="login-title">Đăng nhập Admin</h1>

      <form id="loginForm" novalidate>
        <label class="field">
          <span class="label-text">Tài khoản</span>
          <div class="input-wrap">
            <!-- user SVG icon (offline) -->
        ...
        <label class="field">
          ...
          <div class="input-wrap">
            <!-- lock SVG icon -->
            <svg class="icon" viewBox="0 0 24 24" aria-hidden="true">
              <path d="M17 8V7a5 5 0 0 0-10 0v1H5v12h14V8h-2zM9 7a3 3 0 0 1 6 0v1H9V7z"/>
            </svg>
  ...
  <script src="../assets/js/admindangnhap.js"></script>
</body>
</html>
