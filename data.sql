...
(11, 'Yonex Nanoflare 1000Z', 'Vợt có tốc độ vung nhanh nhất thế giới, thiết kế Wide Profile Frame', 2, 'Lightning Yellow', 'Yonex', '3U,4U', 'nanoflare_1000z.jpg', 15, 4100000.00, 20.00, 'visible'),
(12, 'Yonex Astrox 88D Pro Gen 3', 'Thế hệ thứ 3 tối ưu cho người chơi cầu sau (Dominate)', 2, 'Black/Silver', 'Yonex', '3U,4U', 'astrox_88d_pro_g3.jpg', 20, 3950000.00, 20.00, 'visible'),
(13, 'Yonex Astrox 88S Pro Gen 3', 'Thế hệ thứ 3 tối ưu cho người chơi cầu trước (Decisive)', 2, 'Emerald Blue', 'Yonex', '3U,4U', 'astrox_88s_pro_g3.jpg', 18, 3950000.00, 20.00, 'visible'),
(14, 'Yonex Arcsaber 11 Pro', 'Vợt công thủ toàn diện huyền thoại, khả năng điều cầu chính xác', 2, 'Grayish Pearl', 'Yonex', '3U,4U', 'arcsaber_11_pro.jpg', 12, 3850000.00, 20.00, 'visible'),
(15, 'Yonex Nanoflare 800 Pro', 'Thiết kế khung Sonic Flare System cho những pha phản tạt chớp nhoáng', 2, 'Deep Green', 'Yonex', '3U,4U', 'nanoflare_800_pro.jpg', 14, 3700000.00, 20.00, 'visible'),
(16, 'Yonex Astrox 77 Pro', 'Vợt thiên công linh hoạt, phù hợp cho cả đơn và đôi', 2, 'High Orange', 'Yonex', '3U,4U', 'astrox_77_pro.jpg', 25, 3600000.00, 20.00, 'visible'),
(17, 'Yonex Nanoflare 700 Pro 2025', 'Phiên bản cải tiến giúp giảm rung chấn tối đa', 2, 'Midnight Blue', 'Yonex', '4U,5U', 'nanoflare_700_pro_2025.jpg', 16, 3650000.00, 20.00, 'visible'),
